...
class TranslationService {
  static final Map<String, Map<String, String>> _responseTranslations = {
    ...
    // Something went wrong (generic error recovery)
    'something_went_wrong': {
      'en': 'Something went wrong, please try again!',
      'hi': 'कुछ गलत हो गया, कृपया पुनः प्रयास करें!',
      'ta': 'ஏதோ தவறு நடந்தது, தயவுசெய்து மீண்டும் முயற்சிக்கவும்!',
    ...
    // Voice validation (1st & 2nd consecutive failure)
    'voice_validation_failed': {
      'en': 'Failed to verify your voice. Please try again.',
      'hi': 'आपकी आवाज सत्यापित नहीं हो सकी। कृपया पुनः प्रयास करें।',
      'ta': 'உங்கள் குரல் சரிபார்க்க முடியவில்லை. மீண்டும் முயற்சிக்கவும்.',
      'te': 'మీ వాయిస్ ధృవీకరించబడలేదు. దయచేసి మళ్ళీ ప్రయత్నించండి.',
      'bn': 'আপনার কণ্ঠস্বর যাচাই করা যায়নি। অনুগ্রহ করে আবার চেষ্টা করুন।',
      'gu': 'તમારી આવાજ ચકાસવામાં નિષ્ફળ. કૃપા કરીને ફરીથી પ્રયાસ કરો.',
      'ml': 'നിങ്ങളുടെ വായിസ് സ്ഥിരീകരിക്കാൻ പരാജയപ്പെട്ടു. ദയവായി വീണ്ടും ശ്രമിക്കുക.',
      'mr': 'तुमचा आवाज प्रमाणित होऊ शकला नाही. कृपया पुन्हा प्रयत्न करा.',
      'kn': 'ನಿಮ್ಮ ಧ್ವನಿಯನ್ನು ಪರಿಶೀಲಿಸಲು ವಿಫಲವಾಯಿತು. ದಯವಿಟ್ಟು ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ.',
      'pa': 'ਤੁਹਾਡੀ ਆਵਾਜ਼ ਦੀ ਪੁਸ਼ਟੀ ਅਸਫਲ। ਕਿਰਪਾ ਕਰਕੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ।',
    },

    // Voice validation (3rd+ consecutive failure - no block, suggest silent room)
    'voice_validation_silent_room_retry': {
      'en': 'Please go to a silent room and try again, or try later.',
      'hi': 'कृपया शांत कमरे में जाएं और पुनः प्रयास करें, या बाद में कोशिश करें।',
      'ta': 'தயவுசெய்து அமைதியான அறைக்குச் சென்று மீண்டும் முயற்சிக்கவும், அல்லது பின்னர் முயற்சிக்கவும்.',
      'te': 'దయచేసి నిశ్శబ్ద గదికి వెళ్లి మళ్ళీ ప్రయత్నించండి, లేదా తర్వాత ప్రయత్నించండి.',
      'bn': 'অনুগ্রহ করে একটি নীরব ঘরে যান এবং আবার চেষ্টা করুন, অথবা পরে চেষ্টা করুন।',
      'gu': 'કૃપા કરીને શાંત ઓરડામાં જાઓ અને ફરીથી પ્રયાસ કરો, અથવા પછી પ્રયાસ કરો.',
      'ml': 'ദയവായി നിശ്ശബ്ദമായ മുറിയിലേക്ക് പോയി വീണ്ടും ശ്രമിക്കുക, അല്ലെങ്കിൽ പിന്നീട് ശ്രമിക്കുക.',
      'mr': 'कृपया शांत खोलीत जा आणि पुन्हा प्रयत्न करा, किंवा नंतर प्रयत्न करा.',
      'kn': 'ದಯವಿಟ್ಟು ನಿಶ್ಯಬ್ಧ ಕೊಠಡಿಗೆ ಹೋಗಿ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ, ಅಥವಾ ನಂತರ ಪ್ರಯತ್ನಿಸಿ.',
      'pa': 'ਕਿਰਪਾ ਕਰਕੇ ਇੱਕ ਚੁੱਪ ਕਮਰੇ ਵਿੱਚ ਜਾਓ ਅਤੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ, ਜਾਂ ਬਾਅਦ ਵਿੱਚ ਕੋਸ਼ਿਸ਼ ਕਰੋ।',
    },

    // Voice validation (lockout - legacy, no longer used)
    'voice_validation_silent_room': {
      'en': 'Please go to a silent room and try again, or try later. You can try again after {time}.',
      'hi': 'कृपया शांत कमरे में जाएं और पुनः प्रयास करें, या बाद में कोशिश करें। आप {time} के बाद पुनः प्रयास कर सकते हैं।',
      'ta': 'தயவுசெய்து அமைதியான அறைக்குச் சென்று மீண்டும் முயற்சிக்கவும், அல்லது பின்னர் முயற்சிக்கவும். நீங்கள் {time} க்குப் பிறகு மீண்டும் முயற்சிக்கலாம்.',
      'te': 'దయచేసి నిశ్శబ్ద గదికి వెళ్లి మళ్ళీ ప్రయత్నించండి, లేదా తర్వాత ప్రయత్నించండి. మీరు {time} తర్వాత మళ్ళీ ప్రయత్నించవచ్చు.',
      'bn': 'অনুগ্রহ করে একটি নীরব ঘরে যান এবং আবার চেষ্টা করুন, অথবা পরে চেষ্টা করুন। আপনি {time} এর পরে আবার চেষ্টা করতে পারেন।',
      'gu': 'કૃપા કરીને શાંત ઓરડામાં જાઓ અને ફરીથી પ્રયાસ કરો, અથવા પછી પ્રયાસ કરો. તમે {time} પછી ફરીથી પ્રયાસ કરી શકો છો.',
      'ml': 'ദയവായി നിശ്ശബ്ദമായ മുറിയിലേക്ക് പോയി വീണ്ടും ശ്രമിക്കുക, അല്ലെങ്കിൽ പിന്നീട് ശ്രമിക്കുക. നിങ്ങൾക്ക് {time} കഴിഞ്ഞ് വീണ്ടും ശ്രമിക്കാം.',
      'mr': 'कृपया शांत खोलीत जा आणि पुन्हा प्रयत्न करा, किंवा नंतर प्रयत्न करा. आपण {time} नंतर पुन्हा प्रयत्न करू शकता.',
      'kn': 'ದಯವಿಟ್ಟು ನಿಶ್ಯಬ್ಧ ಕೊಠಡಿಗೆ ಹೋಗಿ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಿ, ಅಥವಾ ನಂತರ ಪ್ರಯತ್ನಿಸಿ. ನೀವು {time} ನಂತರ ಮತ್ತೆ ಪ್ರಯತ್ನಿಸಬಹುದು.',
      'pa': 'ਕਿਰਪਾ ਕਰਕੇ ਇੱਕ ਚੁੱਪ ਕਮਰੇ ਵਿੱਚ ਜਾਓ ਅਤੇ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰੋ, ਜਾਂ ਬਾਅਦ ਵਿੱਚ ਕੋਸ਼ਿਸ਼ ਕਰੋ। ਤੁਸੀਂ {time} ਦੇ ਬਾਅਦ ਦੁਬਾਰਾ ਕੋਸ਼ਿਸ਼ ਕਰ ਸਕਦੇ ਹੋ।',
    },
    ...
    'empty_recording': {
      ...
      'hi': 'कृपया कुछ बोलें।',
      'ta': 'தயவுசெய்து ஏதாவது சொல்லுங்கள்.',
      'te': 'దయచేసి ఏదైనా చెప్పండి.',
      'bn': 'অনুগ্রহ করে কিছু বলুন।',
      'gu': 'કૃપા કરીને કંઈક બોલો.',
      'ml': 'ദയവായി എന്തെങ്കിലും പറയുക.',
      'mr': 'कृपया काहीतरी बोला.',
      'kn': 'ದಯವಿಟ್ಟು ಏನಾದರೂ ಹೇಳಿ.',
      'pa': 'ਕਿਰਪਾ ਕਰਕੇ ਕੁਝ ਕਹੋ।',
    },
  };
